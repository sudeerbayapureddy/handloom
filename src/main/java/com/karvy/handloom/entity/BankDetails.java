...
public class BankDetails extends PseudoColumns implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="BD_Bank_Id", nullable = false,insertable = false,updatable = false)
	...
	//bi-directional many-to-one association to LoomDetails
	@OneToMany(mappedBy="hsBankDetails")
	private List<LoomDetails> loomDetails;
}